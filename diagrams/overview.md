...
```
  ...
  |                                                        |
  |  tfn-backdoor-agent (BLPOP executor) -- LIVE front 05-31|
  |    +- ☎ +1 888 601-6132 -> Twilio -> tfn.93.fyi (Vercel)|
  |    +- ...-> Upstash KV queue -> BLPOP -> dispatch       |
  ...
  |    +- Vercel front LIVE; this Mac executor NOT loaded   |
  |                                                        |
